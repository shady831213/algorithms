...
func (m *rsVEBTreeUInt32Mixin) Less(u int, k1, k2 interface{}) bool {
	return (k1.(uint32) & ((1 << uint32(u)) - 1)) < (k2.(uint32) & ((1 << uint32(u)) - 1))
}

func (m *rsVEBTreeUInt32Mixin) High(u int, key interface{}) interface{} {
	return (key.(uint32) & ((1 << uint32(u)) - 1)) >> uint32(u>>1)
}
